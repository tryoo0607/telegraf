...
func Parse(acc telegraf.Accumulator, buf []byte) error {
	...
	for i := range s.Gpu {
		...
		common.SetIfUsed("str", fields, "gpu_ecc_agg_dram_correctable", gpu.EccErrors.Aggregate.DramCorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_agg_dram_uncorrectable", gpu.EccErrors.Aggregate.DramUncorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_agg_sram_correctable", gpu.EccErrors.Aggregate.SramCorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_agg_sram_uncorrectable", gpu.EccErrors.Aggregate.SramUncorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_vol_dram_correctable", gpu.EccErrors.Volatile.DramCorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_vol_dram_uncorrectable", gpu.EccErrors.Volatile.DramUncorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_vol_sram_correctable", gpu.EccErrors.Volatile.SramCorrectable)
		common.SetIfUsed("str", fields, "gpu_ecc_vol_sram_uncorrectable", gpu.EccErrors.Volatile.SramUncorrectable)
		...
		common.SetIfUsed("float", fields, "current_power_limit", gpu.GpuPowerReadings.CurrentPowerLimit)
